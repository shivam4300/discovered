...
{ 
    ...
    */
    ...
    {   
        $this->storageZoneName = $param['storageZoneName'];
        $this->apiAccessKey = $param['apiAccessKey'];
        $this->storageZoneRegion = strtolower($param['storageZoneRegion']);
    }
