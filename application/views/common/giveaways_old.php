...
.dis_winner_Profile > img {
    width: 100%;
    height: 100%;
    border-radius: 50%;
}
.dis_winnerBox_ttl.dis_aboutus_sub_heading{
    font-size: 20px;
}
.dis_winnerBox_sttl.dis_aboutus_sub_heading{
    font-size: 18px;
...
.dis_gaway_thsirtbox_left > ul > li {
    position: relative;
    padding-left: 40px;
    margin-bottom: 30px;
}
.dis_gaway_thsirtbox_left > ul > li:last-child {
    margin-bottom: 0px;
}
.dis_gaway_thsirtbox_left > ul > li:after {
    content: "";
    position: absolute;
    top: 0;
    left: 0;
...
.dis_gaway_thsirtbox_left > ul > li .dis_aboutus_sub_heading {
    font-size: 20px;
}
.dis_winnerBox_wrap .dis_wbwsh {
    font-size: 20px;
}
/* winner */
...
.dis_gaway_thsirtbox_left {
    width: 60%;
}
.dis_gaway_thsirtbox_right{
    width: 40%;
}
.dis_winner_Profile {
    margin-right: 30px;
...
<div class="dis_aboutus_wrap">
    <div class="dis_aboutus_inner">
        <div class="dis_aboutus_inner">
                        ...
                        <div class="col-md-12">
                            <div class="dis_aboutus_inner">
                                ...
                                <div class="dis_aboutus_ifram">
                                    <iframe src="https://discovered.tv/embed/6503?controls=true&autoplay=false&muted=false&loop=true"  width="100%" height="655px" frameborder="0" allow="autoplay" allowfullscreen="true"></iframe>
                                </div>
            ...
            <div class="dis_gaway_price dis_main_bg">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="dis_aboutus_inner text-center">
                                <p class="dis_aboutus_sub_heading heading m_b_20">BALL'N & DISCOVERED GIVEAWAY</p>
                                <p class="dis_aboutus_sub_heading m_b_30">Enter to win: Nov 1, 2021 thru Feb 28, 2022</p>
                                <p class="dis_aboutus_sub_heading m_b_50">3 Grand Prize Winners Receive A BALL'N NBALAB 10 Team T-shirt Pack</p>

                            </div>
                        </div>
                    </div>
                    <div class="dis_gaway_thsirtbox">
                        <div class="dis_gaway_thsirtbox_left">
                            <ul>
                                <li ><p class="dis_aboutus_sub_heading mp_0">10 Pack Consists Of 10 BALL'N NBALAB Team T-shirts</p></li>
                                <li><p class="dis_aboutus_sub_heading mp_0"> Lucky Winners will be announced on March 1st 2022</p></li>
                            </ul>
                        </div>
                        <div class="dis_gaway_thsirtbox_right">
                            <div class="dis_aboutus_inner">
                                <img src="<?php echo base_url('repo/images/give_tshirt.png'); ?>" alt="image" class="img-responsive">
                            </div>
                        </div>
                    </div>
                    <!-- <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="col-md-6">
                                <div class="dis_aboutus_inner">
                                    <p class="dis_aboutus_sub_heading"><img src="<?php echo base_url('repo/images/aboutpage/aboutus_bullet.png'); ?>" alt="image" class="img-responsive"> 10 Pack Consists Of 10 BALL'N NBALAB Team T-shirts</p>
                                    <p class="dis_aboutus_sub_heading"> <img src="<?php echo base_url('repo/images/aboutpage/aboutus_bullet.png'); ?>" alt="image" class="img-responsive">Lucky Winners will be announced on March 1st 2022</p>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="dis_aboutus_inner">
            ...
            <div class="dis_aboutus_sec_six dis_gaway_entries text-center">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="dis_aboutus_inner">
                                <p class="dis_aboutus_sub_heading  heading m_b_50">Total Entries - <?= $giveawaysCount; ?></p>
                            </div>
                            <div class="dis_aboutus_inner">
            ...
            <div class="dis_gaway_nsletter dis_main_bg text-center" id="dis_gaway_nsletter">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="dis_aboutus_inner">
                                <p class="dis_aboutus_sub_heading  m_b_20">BALL'N & DISCOVERED GIVEAWAY</p>
            ...
            <div class="dis_aboutus_winner dis_main_bg muli_font">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="dis_aboutus_inner">
                                <p class="dis_aboutus_sub_heading  text-center m_b_50">OFFICIAL ANNOUNCEMENT</p>
                            </div>
                        </div>
                        <div class="col-lg-offset-2 col-lg-8 col-md-offset-2 col-md-8 col-sm-offset-1 col-sm-10">
                            <div class="dis_winnerBox_wrap">
                            <p class="dis_aboutus_sub_heading dis_wbwsh text-center m_b_20">WINNER OF THE PERFECT 10 DISCOVERED GIVEAWAY </p>
                                <div class="dis_winnerBox">
                                    <div class="dis_winnerBox_left">
                                        <span class="dis_winner_Profile">
                                            <img src="https://test.discovered.tv/repo/images/banner_logo1.png" alt="profile" class="img-reponsive">
                                        </span>
                                    </div>
                                    <div class="dis_winnerBox_right">
                                        <h2 class="dis_winnerBox_ttl dis_aboutus_sub_heading mp_0">Vilas Chouhan</h2>
                                        <h2 class="dis_winnerBox_sttl dis_aboutus_sub_heading mp_0">Brand - Social, Television, Music, Flim</h2>
                                        <p class="dis_winnerBox_des mp_0">Los Angeles, California, United State</p>
                                    </div>
                                </div>
                            </div>
                        </div>
	...
	$('#creator_compensation').on('shown.bs.modal', function (e) {
	  $('#creator_poup').attr('src','https://discovered.tv/embedcv/3989?autoplay=true&loop=true')
        ...
        (function () {
            ...
            let offer = "febuary 28, 2022 11:53:00",
