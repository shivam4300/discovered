...
<!-- <script type="text/javascript" src="<?php echo base_url();?>repo/js/player/videojs-http-source-selector.min.js"></script>
<script type="text/javascript" src="<?php echo base_url();?>repo/js/player/videojs-contrib-quality-levels.min.js"></script>	 -->
<script type="text/javascript" src="<?php echo base_url();?>repo/js/player/player.js?q=<?=VRSN;?>"></script>
</html>