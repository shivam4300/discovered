                ...
                <div class="dis_single_ticket_inner">
                    ...
                    <div class="dis_st_chatbox_wrap">
                        <div class="dis_st_chatbox_wrap">
                            <div class="dis_ticket_chat_receiver m_b_30 m_t_30">
                                <div class="dis_ticket_chatbox">
                                    ...
                                    <div class="dis_ticket_chat_data">
                                        <h2 class="dis_ticket_cd_ttl mp_0 m_b_10"><?=$cuser['user_name']?> </h2><h2 class="dis_ticket_cd_ttl mp_0 m_b_10">Created Ticket - <?=date("j F Y g:i a",strtotime($this->common->manageTimezone($ticketDatas['created_at'])));?> </h2>
                            ...
                            <form class="adminReplyForm" action="support/adminTicketReply">
                                ...
                                <div class="dis_ticket_chat_sender m_b_30">
                                    <div class="dis_ticket_chatbox">
                                        <div class="dis_ticket_chat_thumb">
                                            <span class="dis_ticket_chat_timg">
                                                <img src="<?=base_url('repo/images/banner_logo1.png');?>" alt="thumb" class="img-responsive" onerror="this.onerror=null;this.src='<?= user_default_image(); ?>'">
                                            </span>
                                        </div>
                                ...
                                <ul class="dis_ticket_chat_submit_btn">
                                    <li>
                                        <a href="<?php echo base_url('support/dashboard');?>" class="dis_btn gray_btn min_width_inherit b-r-5">Back</a>
                                    </li>
                                    <li>
...
<div class="dis_ticket_trensfer_modal modal dis_center_modal fade in" id="showFileData" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
