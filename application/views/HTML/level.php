							...
							<div class="dis_signup_right_inner dis_choose_account">
								...
								<div class="dis_choose_type">
									<div class="dis_account_type">
										<div class="row">
											<div class="col-md-6">
												<a href="#" class="au_host_btn label">icon</a>
											</div>
											<div class="col-md-6">
												<a href="#" class="au_host_btn label">Emerging creator</a>
											</div>
											<div class="col-md-6">
												<a href="#" class="au_host_btn label">brand</a>
											</div>
											<div class="col-md-6">
												<a href="#" class="au_host_btn label">fan</a>
											</div>
										<div class="col-md-12">
												<a href="#" class="au_host_btn  dis_acc_btn">Next</a>
											</div>
										</div>
									</div>
								</div>
