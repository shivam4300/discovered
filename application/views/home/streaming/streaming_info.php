...
<?php if($status == 0 || $status == 2 || $status == 3){ ?> <!--When status is disable or requested -->
			...
			<div class="col-md-12">
				<div class="dis_sinfo_inner">
                    <div class="dis_steaming_rf_box"> 
						...
						<form action="Streaming/requestToLiveStream" class="RequestToLiveStream">
...
<section class="dis_stream_stepprocess_wrap">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                            ...
                            <div class="tab-pane" id="step3">
                                <div class="dis_stream_sp_tab_inner">
                                        ...
                                        <div class="dis_upload_video_inner">                        
                                            <div class="row">
                                                <div class="col-lg-offset-1 col-lg-10">                                                    
                                                    <p class="dis_stream_sp_des m_b_10">After installing OBS software, you need to configure the settings to enable live streaming.</h2>
                                                    <p class="dis_stream_sp_des m_b_30">Watch the video below to see how OBS software needs to be set-up<br> or <a class="primary_link" href="<?= base_url('repo/images/streaming_pdf.pdf'); ?>" target="_blank"> click here </a>to follow the instructions.</h2>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="dis_stream_sp_btwrap m_t_30">
										...
										?>	
										 <li><a target="_blank" href="<?= $href; ?>" class="dis_btn stream_sp_btn stream_sp_next_step" id="LiveKey">Go To Live Stream</a></li>   											
                                        </ul>
                                    </div>                                    
                                </div>
                            </div>
