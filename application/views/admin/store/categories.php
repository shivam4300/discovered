        ...
        <div class="col-xs-12">
          <div class="box">
            ...
            <div class="box-body table-responsive">
              ...
              <table class="table dt-responsive nowrap hover display dataTableAjax" data-search="true" data-action-url="admin_store/show_categories" data-target-section="tbody" data-column-class="[{className: 'sr'},{className: 'thumb'},{className: 'name'},{className: 'slug'},{className: 'edit'},{className: 'delete'}]"  data-refresh-dataTablePosition='0' data-orders="[]" data-sort="[{ targets: [0,1,2], orderable: false}]">
                <thead>
                  <tr>
                    <th class="sr">#</th> 
...
<div class="modal fade" id="category" role="dialog">
    <div class="modal-dialog">
        ...
        <form action="admin_store/addEditCategory" method="POST" class="myFormList" data-model-hide="#category">
