<?php echo $this->common_html->ConfirmNotificationModal(); ?>
					...
					<div class="row">
						<div class="col-md-12">
							<div class="table_content">
								 <table class="table dt-responsive nowrap hover display dataTableAjax" data-action-url="backend/store/show_my_orders" data-table-position="0" data-target-section="tbody" cellspacing="0" width="100%" data-column-class="[{className: 'srno'},{className: 'orderid'},{className: 'date'},{className: 'price'},{className: 'status'},{className: 'paymode'},{className: 'orderkey'},{className: 'action'}]"	data-filter='1' data-refresh-dataTablePosition="0" data-orders="[[2,'DESC']]">
									<thead>
										<tr>
											<th class="srno">Sno.
											...
											<th class="short_icon orderid">Order ID</th>
											<th class="short_icon date">Date</th>
											<th class="short_icon price" >Earning</th>
											<th class="short_icon status">Status</th>
											<th class="short_icon paymode">Pay Mode</th>
											<th class="orderkey">Order Key</th>
	...
	<style>
		.show {
			opacity: 1; visibility: visible; transform: translateY(0px) rotateY(0deg); -webkit-transform: translateY(0px) rotateY(0deg); -moz-transform: translateY(0px) rotateY(0deg);
		}
	</style>
	<div class="dis_common_popup dis_stmnt_popup" >
		
		<div class="common_popup_inner stmnt_inner">
