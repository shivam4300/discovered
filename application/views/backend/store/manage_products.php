							...
							<div class="table_topmenus">
                                ...
                                <div class="left_menu">
									<div class="tbl_tm_dropdown export">
										<a href="<?php echo base_url('backend/store/createProduct'); ?>" class="table_embedbtn">Add Product</a>
									</div>
									<div class="tbl_tm_dropdown export">
					...
					<div class="row">
						<div class="col-md-12">
							<div class="table_content">
								 <table class="table dt-responsive nowrap hover display dataTableAjax" data-action-url="backend/store/show_my_products" data-table-position="0" data-target-section="tbody" cellspacing="0" width="100%" data-column-class="[{className: 'srno'},{className: 'preview'},{className: 'title'},{className: 'sku'},{className: 'stock'},{className: 'price'},{className: 'cate'},{className: 'date'},{className: 'status'},{className: 'action'}]"	data-filter='1' data-refresh-dataTablePosition="0" data-orders="[[2,'DESC']]">
									<thead>
										<tr>
											<th class="srno">
											...
											<th class="sku">SKU</th>
											<th class="short_icon stock">Stock</th>
											<th class="short_icon price" >Price</th>
											<th class="short_icon cate">Categories</th>
