...
class CreateCustomTargetingKeysAndValues
{
    ...
    public static function runExample(
        ...
        */
        ...
        $carModelHondaCivicValue->setCustomTargetingKeyId(12070650);
        // $carModelHondaCivicValue->setDisplayName('video_id');
        
        for($i = 80100; $i <= 100100 ; $i++ ){
            try {
            $carModelHondaCivicValue->setName($i);
