(function t(e, i, n) {
        ...
        var c = i.VPAIDAdUnit = function(t) {
            ...
            r(e, [{
                ...
                value: function h(t, e, i, n) {
                    ...
                    this._flash.callFlashMethod("initAd", [this._flash.getWidth(), this._flash.getHeight(), i, n, r.AdParameters || "", a.flashVars || ""], s)
                }
            }, {
                key: "resizeAd",
    ...
    3: [function(t, e, i) {
        ...
        var g = function() {
            function t(e, i) {
                ...
                h.movie = n.data;
                h.FlashVars = "flashid=" + this._flashID + "&handler=" + s.VPAID_FLASH_HANDLER + "&debug=" + p.debug + "&salign=" + h.salign;
                if (!t.isSupported()) {
                ...
                var g = l(p.timeout, function(t, e) {
                    A.call(o);
                    i(t, e)
                }, function() {
    ...
    5: [function(t, e, i) {
        ...
        Object.defineProperty(h, "VPAID_FLASH_HANDLER", {
            writable: false,
            configurable: false,
            value: d
        });
    ...
    9: [function(t, e, i) {
        ...
        var a = ["getAdLinear", "getAdWidth", "getAdHeight", "getAdExpanded", "getAdSkippableState", "getAdRemainingTime", "getAdDuration", "getAdVolume", "getAdCompanions", "getAdIcons"];
        var s = ["setAdVolume"];
    ...
    10: [function(t, e, i) {
        ...
        function h(t, e, i) {
            this._subscribers.triggerSync(l, {
                url: t,
                id: e,
                playerHandles: i
            })
    ...
    11: [function(t, e, i) {
        ...
        var a = t("./VPAIDAdUnit");
        var s = "<!DOCTYPE html>" + '<html lang="en">' + '<head><meta charset="UTF-8"></head>' + '<body style="margin:0;padding:0"><div class="ad-element"></div>' + '<script type="text/javascript" src="{{iframeURL_JS}}"></script>' + '<script type="text/javascript">' + 'window.parent.postMessage(\'{"event": "ready", "id": "{{iframeID}}"}\', \'{{origin}}\');' + "</script>" + "</body>" + "</html>";
        var o = "AdStopped";
        ...
        u.prototype.loadAdUnit = function A(t, e) {
            ...
            d.call(this);
            var i = this;
            var r = n.createIframeWithContent(this._frameContainer, this._templateConfig.template, n.extend({
                iframeURL_JS: t,
                iframeID: this.getID(),
                origin: y()
    ...
    14: [function(t, e, i) {
        (function(t, i) {
            ...
            var t = "undefined",
                ...
                T = false,
                E = function() {
                    var a = typeof u.getElementById !== t && typeof u.getElementsByTagName !== t && typeof u.createElement !== t,
                    ...
                    if (typeof l.plugins !== t && typeof l.plugins[i] === e) {
                        ...
                        if (g && (typeof l.mimeTypes !== t && l.mimeTypes[r] && l.mimeTypes[r].enabledPlugin)) {
                            ...
                            y[0] = z(g.replace(/^(.*)\..*$/, "$1"));
                            y[1] = z(g.replace(/^.*\.(.*)\s.*$/, "$1"));
                            y[2] = /[a-zA-Z]/.test(g) ? z(g.replace(/^.*[a-zA-Z]+(.*)$/, "$1")) : 0
                        }
                ...
                S = function() {
                    ...
                    if (typeof u.readyState !== t && (u.readyState === "complete" || u.readyState === "interactive") || typeof u.readyState === t && (u.getElementsByTagName("body")[0] || u.body)) {
                        V()
                    }
                    if (!A) {
            ...
            function D(e, i, n, r) {
                ...
                if (s) {
                    ...
                    e.id = a;
                    if (typeof e.width === t || !/%$/.test(e.width) && z(e.width) < 310) {
                        e.width = "310"
                    }
                    if (typeof e.height === t || !/%$/.test(e.height) && z(e.height) < 137) {
                        e.height = "137"
                    }
                    var l = E.ie ? "ActiveX" : "PlugIn",
                        c = "MMredirectURL=" + encodeURIComponent(o.location.toString().replace(/&/g, "%26")) + "&MMplayerType=" + l + "&MMdoctitle=" + encodeURIComponent(u.title.slice(0, 47) + " - Flash Player Installation");
            ...
            function R(t, e) {
                var i = q("div");
                i.innerHTML = "<object classid='clsid:D27CDB6E-AE6D-11cf-96B8-444553540000'><param name='movie' value='" + t + "'>" + e + "</object>";
                return i.firstChild
            }
    ...
    20: [function(t, e, i) {
        ...
        var n = t("../../utils/xml");
        var r = t("./vastUtil");
        var a = ["delivery", "type", "width", "height", "codec", "id", "bitrate", "minBitrate", "maxBitrate", "scalable", "maintainAspectRatio", "apiFramework"];
    ...
    22: [function(t, e, i) {
        ...
        f.prototype._getVASTAd = function(t, e) {
            ...
            function f(t, e, n) {
                if (e.length >= i.WRAPPER_LIMIT) {
                    return n(new r("on VASTClient.getVASTAd.getAd, players wrapper limit reached (the limit is " + i.WRAPPER_LIMIT + ")", 302), e)
                }
                o.waterfall([function(e) {
                    if (l.isString(t)) {
                        v(t, e)
                    } else {
                        e(null, t)
        ...
        f.prototype._requestVASTXml = function p(t, e) {
            ...
            function n(t, i, n) {
                if (t) {
                    var a = l.isDefined(n) ? "on VASTClient.requestVastXML, HTTP request error with status '" + n + "'" : "on VASTClient.requestVastXML, Error getting the the VAST XML with he passed adTagXML fn";
                ...
                if (e) {
                    e.forEach(function(t) {
                        if (!l.isNumber(t.offset)) {
                            throw new r("on VASTClient._buildVASTResponse, missing or wrong offset attribute on progress tracking event", 101)
                        }
                    })
                }
            }
    ...
    24: [function(t, e, i) {
        ...
        f.prototype.playAd = function h(t, e) {
            ...
            o.waterfall([function(e) {
                e(null, t)
            }, this._selectAdSource.bind(this), this._createVASTTracker.bind(this), this._addClickThrough.bind(this), this._addSkipButton.bind(this), this._setupEvents.bind(this), this._playSelectedAd.bind(this)], function(t, n) {
                if (t && n) {
                    i._trackError(t, n)
                }
                e(t, n)
        ...
        f.prototype._addClickThrough = function m(t, e, i, n) {
            ...
            function h(e, i) {
                var n = {
                    ASSETURI: t.src,
                    CONTENTPLAYHEAD: s.formatProgress(i.currentTime() * 1e3)
                };
        ...
        o.prototype.trackURLs = function u(t, e) {
            if (s.isArray(t) && t.length > 0) {
                e = s.extend({
                    ...
                    CONTENTPLAYHEAD: a.formatProgress(this.progress)
                }, e || {});
                a.track(t, e)
            }
        };
    ...
    28: [function(t, e, i) {
        ...
        function o(t) {
            ...
            this.error = s.keyValue(t.error);
            this.extensions = t.extensions;
            this.followAdditionalWrappers = a.isDefined(s.attr(t, "followAdditionalWrappers")) ? s.attr(t, "followAdditionalWrappers") : true;
    ...
    30: [function(t, e, i) {
        ...
        var o = {
            ...
            formatProgress: function p(t) {
                ...
                r = Math.floor(r);
                a = t % 1e3;
                return n.toFixedDigits(e, 2) + ":" + n.toFixedDigits(i, 2) + ":" + n.toFixedDigits(r, 2) + "." + n.toFixedDigits(a, 3)
            },
        ...
        function a(t, e) {
            ...
            function i(t, e) {
                if (!t || !a.checkVPAIDInterface(t)) {
                    throw new n("on VPAIDAdUnitWrapper, the passed VPAID adUnit does not fully implement the VPAID interface")
                }
                if (!r.isObject(e)) {
    ...
    32: [function(t, e, i) {
        ...
        l.prototype.loadAdUnit = function c(t, e, i) {
            var n = this;
            var a = this.settings && this.settings.vpaidFlashLoaderPath ? {
                data: this.settings.vpaidFlashLoaderPath
            } : undefined;
            c(t, i);
            this.containerEl = t;
            u.debug("<VPAIDFlashTech.loadAdUnit> loading VPAIDFLASHClient with opts:", a);
            this.vpaidFlashClient = new l.VPAIDFLASHClient(t, function(t) {
                if (t) {
                    return i(t)
                }
    ...
    34: [function(t, e, i) {
        ...
        p.prototype.playAd = function g(t, e) {
            ...
            if (s) {
                ...
                l.waterfall([function(e) {
                    e(null, s, t)
                }, this._loadAdUnit.bind(this), this._playAdUnit.bind(this), this._finishPlaying.bind(this)], u);
                this._adUnit = {
                    _paused: true,
                    type: "VPAID",
                    pauseAd: function() {
        ...
        p.prototype._playAdUnit = function(t, e, i) {
            l.waterfall([function(i) {
                i(null, t, e)
            }, this._handshake.bind(this), this._initAd.bind(this), this._setupEvents.bind(this), this._addSkipButton.bind(this), this._linkPlayerControls.bind(this), this._startAd.bind(this)], i)
        };
        ...
        var a = function(t) {
            return {
                init: function e(i, a) {
                    ...
                    t.call(this, i, a);
                    setTimeout(function() {
                        var t = i.controlBar && (i.controlBar.getChild("timerControls") || i.controlBar.getChild("currentTimeDisplay"));
                        if (t) {
